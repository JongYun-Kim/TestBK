...
from TARL_random_speed_env import TAEnvDynaRand
...
if __name__ == "__main__":
    ...
    # register_env("NSenv2", lambda _: TAEnvMovingTasksInEpisode(num_uav, num_task, task_vel))
    register_env("NSRANDenv", lambda _: TAEnvDynaRand(num_uav, num_task, True, 0, 15, False, 0, 0))

    # Configuration settings
    rl_algo = "PPO"
    # rl_algo = "IMPALA"
    save_name = "{}a{}t{}v_RAND_0-15".format(rl_algo, num_uav, num_task)
    # save_name =
