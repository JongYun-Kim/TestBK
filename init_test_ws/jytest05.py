    ...
    def on_train_result(self, *, trainer, result: dict, **kwargs):
        ...
        if np.isnan(result['episode_reward_mean']):
            ...
            if current_reward1 > self.men_rewards1[key_min1]:
                ...
                # select one policy randomly. The menagerie length must exclude potential nans in the beginning
...
if __name__ == "__main__":
    ...
    def env_creator(args):
        ...
        env_o = simple_tag_v2.env(num_good=1, num_adversaries=3, num_obstacles=2, max_cycles=120, continuous_actions=False)
    ...
    def policy_mapping_fn(agent_id):
        if agent_id in ['adversary_0', 'adversary_1', 'adversary_2']:
    ...
    # policies = {"adversary_policy": (),}

    tune.run(
        "PPO",
        name="PPO_mpe_pray1_pred3_torch_trial_1",
